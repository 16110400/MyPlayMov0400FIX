package com.playmov.myplaymov0400.adapter;
...
import com.playmov.myplaymov0400.DetailActivity;
import com.playmov.myplaymov0400.R;
...
//    TextView Judul,Overview;
    ...
    public void onBindViewHolder(final MovieHolder holder, final int position) {
        Picasso.with(holder.itemView.getContext())
                .load("https://image.tmdb.org/t/p/w200/"+results.get(position).getPosterPath())
                .into(holder.Poster);
